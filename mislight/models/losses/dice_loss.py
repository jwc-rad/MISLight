...
class DiceLoss(GenericLoss):
    ...
    def __init__(self, dice_kwargs, apply_nonlin=[True, False], pre_avg=True, argmax=False, **kwargs):
        ...
        self.argmax = argmax
        self.dc = SoftDiceLoss(apply_nonlin=None, **dice_kwargs)
...
'''Below Copied from: https://github.com/MIC-DKFZ/nnUNet/blob/master/nnunet/training/loss_functions/dice_loss.py
'''
