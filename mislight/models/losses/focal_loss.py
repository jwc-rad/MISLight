...
class GenericFocalLoss(GenericLoss):
    ...
    def __init__(self, ce_kwargs, apply_nonlin=[False, False], pre_avg=True, argmax=False, **kwargs):
        ...
        self.argmax = argmax
        self.ce = FocalLoss(apply_nonlin=None, **ce_kwargs)
...
'''Below Copied from: https://github.com/JunMa11/SegLoss/blob/master/test/nnUNetV2/loss_functions/focal_loss.py
'''
