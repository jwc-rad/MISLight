...
python -m mislight.scripts.test --no_saveoptions --gpu_ids $GPU --dataroot $DATAROOT --run_base_dir $RUN_DIR --batch_size $BATCH_SIZE --train_ds_info $PATH_DS2 --load_pretrained $PATH_CK2 --dir_previous $TEST_PREV_DIR --force_cpu_process --inference_model 0
