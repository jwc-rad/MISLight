'''Official MICCAI FLARE 2022 Evaluation Code
Changes:
    docker device gpu id as arg
'''
...
if __name__ == "__main__":
    ...
    parser.add_argument("-gpus", default=1, type=int, help="CUDA_VISIBLE_DEVICES")
    ...
    try:
        ...
        # )
        cmd = 'docker container run --gpus="device={}" --name {} --rm -v $PWD/inputs/:/workspace/inputs/ -v $PWD/outputs/:/workspace/outputs/ {}:latest /bin/bash -c "sh predict.sh" '.format(args.gpus, args.docker_name, args.docker_name)
